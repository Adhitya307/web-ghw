...
<head>
    ...
    <title><?= $title ?? 'Edit Data Extensometer - PT Indonesia Power' ?></title>
    ...
    <div class="row justify-content-center">
        <div class="col-12">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h2 class="mb-0">
                    <i class="fas fa-edit me-2 text-warning"></i>Edit Data Extensometer
                </h2>
            ...
            <?php if (isset($extenso)): ?>
            <form action="<?= base_url('extenso/update/' . $extenso['id']) ?>" method="POST" id="extensoForm">
                <?= csrf_field() ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <select class="form-select" id="periode" name="periode" required>
                                ...
                                <option value="TW-1" <?= old('periode', $extenso['periode']) == 'TW-1' ? 'selected' : '' ?>>TW-1</option>
                                <option value="TW-2" <?= old('periode', $extenso['periode']) == 'TW-2' ? 'selected' : '' ?>>TW-2</option>
                                <option value="TW-3" <?= old('periode', $extenso['periode']) == 'TW-3' ? 'selected' : '' ?>>TW-3</option>
                                <option value="TW-4" <?= old('periode', $extenso['periode']) == 'TW-4' ? 'selected' : '' ?>>TW-4</option>
                            </select>
                        </div>
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="date" class="form-control" id="tanggal" name="tanggal" 
                                   value="<?= old('tanggal', $extenso['tanggal']) ?>" required>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12 mb-3">
                            ...
                            <input type="text" class="form-control dma-input no-comma-input" 
                                   id="dma" name="dma" 
                                   value="<?= old('dma', $extenso['dma']) ?>" placeholder="Masukkan DMA"
                ...
                <?php for($i = 1; $i <= 4; $i++): 
                    $currentEx = 'ex' . $i;
                    $pembacaan10 = old('ex'.$i.'_pembacaan_10', $extenso['ex'.$i.'_pembacaan_10'] ?? '');
                    $pembacaan20 = old('ex'.$i.'_pembacaan_20', $extenso['ex'.$i.'_pembacaan_20'] ?? '');
                    $pembacaan30 = old('ex'.$i.'_pembacaan_30', $extenso['ex'.$i.'_pembacaan_30'] ?? '');
                ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="card h-100">
                                ...
                                <div class="card-body">
                                    <p class="text-muted small mb-3">Edit nilai pembacaan terbaru:</p>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control number-input decimal-input no-comma-input" 
                                               ...
                                               value="<?= $pembacaan10 ?>" placeholder="0.00"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control number-input decimal-input no-comma-input" 
                                               ...
                                               value="<?= $pembacaan20 ?>" placeholder="0.00"
                                               title="Gunakan titik (.) sebagai pemisah desimal">
                                    ...
                                    <div class="mb-0">
                                        ...
                                        <input type="text" class="form-control number-input decimal-input no-comma-input" 
                                               ...
                                               value="<?= $pembacaan30 ?>" placeholder="0.00"
                                               title="Gunakan titik (.) sebagai pemisah desimal">
                        ...
                        <!-- Info Default Values & Current Values -->
                        <div class="col-md-6">
                            <div class="card h-100 info-card">
                                <div class="card-header bg-info text-white">
                                    <h6 class="mb-0"><i class="fas fa-database me-2"></i>NILAI DEFAULT & CURRENT</h6>
                                </div>
                                <div class="card-body">
                                    <div class="mb-3">
                                    ...
                                    <!-- Current Deformasi Values -->
                                    <div class="mt-4 pt-3 border-top">
                                        <h6 class="mb-3"><i class="fas fa-chart-line me-2 text-success"></i>Deformasi Saat Ini</h6>
                                        
                                        <div class="mb-2">
                                            <label class="form-label small">Deformasi 10 m</label>
                                            <div class="form-control current-value">
                                                <?= isset($extenso['ex'.$i.'_deformasi_10']) ? number_format($extenso['ex'.$i.'_deformasi_10'], 2, '.', '') : '0.00' ?>
                                            </div>
                                        </div>
                                        <div class="mb-2">
                                            <label class="form-label small">Deformasi 20 m</label>
                                            <div class="form-control current-value">
                                                <?= isset($extenso['ex'.$i.'_deformasi_20']) ? number_format($extenso['ex'.$i.'_deformasi_20'], 2, '.', '') : '0.00' ?>
                                            </div>
                                        </div>
                                        <div class="mb-0">
                                            <label class="form-label small">Deformasi 30 m</label>
                                            <div class="form-control current-value">
                                                <?= isset($extenso['ex'.$i.'_deformasi_30']) ? number_format($extenso['ex'.$i.'_deformasi_30'], 2, '.', '') : '0.00' ?>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="alert alert-success mt-3">
                                        <small>
                                            ...
                                            <strong>Deformasi akan dihitung ulang</strong><br>
                                            Berdasarkan nilai pembacaan yang diedit
                                        </small>
                                    </div>
                                </div>
                            </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <p class="mb-0"><strong>Detail Data:</strong></p>
                <ul>
                    <li>Tahun: <?= $extenso['tahun'] ?></li>
                    <li>Periode: <?= $extenso['periode'] ?></li>
                    <li>Tanggal: <?= $extenso['tanggal'] ?></li>
                </ul>
            ...
            <div class="modal-footer">
                ...
                <form action="<?= base_url('extenso/delete/' . $extenso['id']) ?>" method="POST" class="d-inline">
                    <?= csrf_field() ?>
