...
<div class="container-fluid py-4">
    ...
    <div class="table-header">
        <h2 class="table-title">
            <i class="fas fa-mountain me-2"></i>Bubble Tilt Meter (BTM) - BT-1
        </h2>
        ...
        <table class="data-table table table-bordered table-hover" id="exportTable">
            <thead>
                ...
                <tr>
                    ...
                    <!-- BACAAN BT1 -->
                    <th colspan="4" class="bg-reading">BACAAN BT-1</th>
            ...
            <tbody id="dataTableBody">
                ...
                <?php else: ?>
                    <?php foreach($pengukuran as $item): 
                        ...
                        // Ambil data untuk BT1
                        $Y_US = $scatter['bt1']['Y_US'] ?? null;
    ...
    document.getElementById('exportExcel').addEventListener('click', function() {
        ...
        setTimeout(() => {
            try {
                ...
                const wb = XLSX.utils.table_to_book(table, {sheet: "Data BT1"});
                
                const timestamp = new Date().toISOString().slice(0, 10).replace(/-/g, '');
                const filename = `BT1_Data_Export_${timestamp}.xlsx`;
