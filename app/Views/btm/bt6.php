            ...
            <tbody id="dataTableBody">
                ...
                <?php else: ?>
                    ...
                    <?php foreach($pengukuran as $item): 
                        ...
                        $A_sec = $bt6Perhitungan['A_sec'] ?? null;
                        $B_sec = $bt6Perhitungan['B_sec'] ?? null;
                        ...
                        $sin_A_rad_display = $sin_A_rad_calculated ?? $bt6Perhitungan['sin_A_rad'] ?? null;
                        $sin_B_rad_display = $sin_B_rad_calculated ?? $bt6Perhitungan['sin_B_rad'] ?? null;
                        $sin_C_rad_display = $sin_C_rad_calculated ?? $bt6Perhitungan['sin_C_rad'] ?? null;
                        $sin_C_deg_display = $sin_C_deg_calculated ?? $bt6Perhitungan['sin_C_deg'] ?? null;
                    ?>
                    <tr data-pid="<?= $p['id_pengukuran'] ?>">
                        ...
                        <!-- BACAAN DATA BT6 -->
                        <td class="number-cell"><?= isset($bt6Bacaan['US_GP']) ? formatNumber($bt6Bacaan['US_GP']) : '-' ?></td>
                        <td><?= esc($bt6Bacaan['US_Arah'] ?? '-') ?></td>
                        <td class="number-cell"><?= isset($bt6Bacaan['TB_GP']) ? formatNumber($bt6Bacaan['TB_GP']) : '-' ?></td>
                        ...
                        <td class="number-cell"><?= isset($bt6Perhitungan['Cosa']) ? formatNumber($bt6Perhitungan['Cosa']) : '-' ?></td>
                        <td class="number-cell"><?= isset($bt6Perhitungan['a_rad']) ? formatNumber($bt6Perhitungan['a_rad']) : '-' ?></td>
