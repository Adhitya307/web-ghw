            ...
            <tbody id="dataTableBody">
                ...
                <?php else: ?>
                    ...
                    <?php foreach($pengukuran as $item): 
                        ...
                        $A_sec = $bt2Perhitungan['A_sec'] ?? null;
                        $B_sec = $bt2Perhitungan['B_sec'] ?? null;
                        ...
                        $sin_A_rad_display = $sin_A_rad_calculated ?? $bt2Perhitungan['sin_A_rad'] ?? null;
                        $sin_B_rad_display = $sin_B_rad_calculated ?? $bt2Perhitungan['sin_B_rad'] ?? null;
                        $sin_C_rad_display = $sin_C_rad_calculated ?? $bt2Perhitungan['sin_C_rad'] ?? null;
                        $sin_C_deg_display = $sin_C_deg_calculated ?? $bt2Perhitungan['sin_C_deg'] ?? null;
                    ?>
                    <tr data-pid="<?= $p['id_pengukuran'] ?>">
                        ...
                        <!-- BACAAN DATA BT2 -->
                        <td class="number-cell"><?= isset($bt2Bacaan['US_GP']) ? formatNumber($bt2Bacaan['US_GP']) : '-' ?></td>
                        <td><?= esc($bt2Bacaan['US_Arah'] ?? '-') ?></td>
                        <td class="number-cell"><?= isset($bt2Bacaan['TB_GP']) ? formatNumber($bt2Bacaan['TB_GP']) : '-' ?></td>
                        ...
                        <td class="number-cell"><?= isset($bt2Perhitungan['Cosa']) ? formatNumber($bt2Perhitungan['Cosa']) : '-' ?></td>
                        <td class="number-cell"><?= isset($bt2Perhitungan['a_rad']) ? formatNumber($bt2Perhitungan['a_rad']) : '-' ?></td>
