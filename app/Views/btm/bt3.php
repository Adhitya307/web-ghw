            ...
            <tbody id="dataTableBody">
                ...
                <?php else: ?>
                    ...
                    <?php foreach($pengukuran as $item): 
                        ...
                        $A_sec = $bt3Perhitungan['A_sec'] ?? null;
                        $B_sec = $bt3Perhitungan['B_sec'] ?? null;
                        ...
                        $sin_A_rad_display = $sin_A_rad_calculated ?? $bt3Perhitungan['sin_A_rad'] ?? null;
                        $sin_B_rad_display = $sin_B_rad_calculated ?? $bt3Perhitungan['sin_B_rad'] ?? null;
                        $sin_C_rad_display = $sin_C_rad_calculated ?? $bt3Perhitungan['sin_C_rad'] ?? null;
                        $sin_C_deg_display = $sin_C_deg_calculated ?? $bt3Perhitungan['sin_C_deg'] ?? null;
                    ?>
                    <tr data-pid="<?= $p['id_pengukuran'] ?>">
                        ...
                        <!-- BACAAN DATA BT3 -->
                        <td class="number-cell"><?= isset($bt3Bacaan['US_GP']) ? formatNumber($bt3Bacaan['US_GP']) : '-' ?></td>
                        <td><?= esc($bt3Bacaan['US_Arah'] ?? '-') ?></td>
                        <td class="number-cell"><?= isset($bt3Bacaan['TB_GP']) ? formatNumber($bt3Bacaan['TB_GP']) : '-' ?></td>
                        ...
                        <td class="number-cell"><?= isset($bt3Perhitungan['Cosa']) ? formatNumber($bt3Perhitungan['Cosa']) : '-' ?></td>
                        <td class="number-cell"><?= isset($bt3Perhitungan['a_rad']) ? formatNumber($bt3Perhitungan['a_rad']) : '-' ?></td>
