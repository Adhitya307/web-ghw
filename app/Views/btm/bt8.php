...
<div class="container-fluid py-4">
    ...
    <div class="table-header">
        <h2 class="table-title">
            <i class="fas fa-mountain me-2"></i>Bubble Tilt Meter (BTM) - <?= strtoupper($currentBt ?? 'BT-8') ?>
        </h2>
        ...
        <table class="data-table table table-bordered table-hover">
            <thead>
                ...
                <tr>
                    ...
                    <!-- BACAAN BT -->
                    <th colspan="4" class="bg-reading">BACAAN <?= strtoupper($currentBt ?? 'BT-8') ?></th>
