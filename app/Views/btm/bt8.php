            ...
            <tbody id="dataTableBody">
                ...
                <?php else: ?>
                    ...
                    <?php foreach($pengukuran as $item): 
                        ...
                        $A_sec = $bt8Perhitungan['A_sec'] ?? null;
                        $B_sec = $bt8Perhitungan['B_sec'] ?? null;
                        ...
                        $sin_A_rad_display = $sin_A_rad_calculated ?? $bt8Perhitungan['sin_A_rad'] ?? null;
                        $sin_B_rad_display = $sin_B_rad_calculated ?? $bt8Perhitungan['sin_B_rad'] ?? null;
                        $sin_C_rad_display = $sin_C_rad_calculated ?? $bt8Perhitungan['sin_C_rad'] ?? null;
                        $sin_C_deg_display = $sin_C_deg_calculated ?? $bt8Perhitungan['sin_C_deg'] ?? null;
                    ?>
                    <tr data-pid="<?= $p['id_pengukuran'] ?>">
                        ...
                        <!-- BACAAN DATA BT8 -->
                        <td class="number-cell"><?= isset($bt8Bacaan['US_GP']) ? formatNumber($bt8Bacaan['US_GP']) : '-' ?></td>
                        <td><?= esc($bt8Bacaan['US_Arah'] ?? '-') ?></td>
                        <td class="number-cell"><?= isset($bt8Bacaan['TB_GP']) ? formatNumber($bt8Bacaan['TB_GP']) : '-' ?></td>
                        ...
                        <td class="number-cell"><?= isset($bt8Perhitungan['Cosa']) ? formatNumber($bt8Perhitungan['Cosa']) : '-' ?></td>
                        <td class="number-cell"><?= isset($bt8Perhitungan['a_rad']) ? formatNumber($bt8Perhitungan['a_rad']) : '-' ?></td>
