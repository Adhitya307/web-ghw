...
<head>
    ...
    <title><?= $title ?? 'Bubble Tilt Meter BT-7 - PT Indonesia Power' ?></title>
...
<div class="container-fluid py-4">
    ...
    <div class="table-header">
        <h2 class="table-title">
            <i class="fas fa-mountain me-2"></i>Bubble Tilt Meter (BTM) - BT-7
        </h2>
        ...
        <div class="btn-group mb-3" role="group">
            ...
            <a href="<?= base_url('btm/bt7') ?>" class="btn btn-primary btn-bt">
                <i class="fas fa-table"></i> BT-7
            </a>
        ...
        <table class="data-table table table-bordered table-hover" id="exportTable">
            <thead>
                ...
                <tr>
                    ...
                    <!-- BACAAN BT7 -->
                    <th colspan="4" class="bg-reading">BACAAN BT-7</th>
            ...
            <tbody id="dataTableBody">
                ...
                <?php else: ?>
                    ...
                    <?php foreach($pengukuran as $item): 
                        ...
                        // Ambil data untuk BT7
                        $Y_US = $scatter['bt7']['Y_US'] ?? null;
    ...
    document.getElementById('exportExcel').addEventListener('click', function() {
        ...
        setTimeout(() => {
            try {
                ...
                const wb = XLSX.utils.table_to_book(table, {sheet: "Data BT7"});
                
                const timestamp = new Date().toISOString().slice(0, 10).replace(/-/g, '');
                const filename = `BT7_Data_Export_${timestamp}.xlsx`;
