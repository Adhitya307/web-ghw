...
<head>
    ...
    <title>Edit Data HDM - PT Indonesia Power</title>
...
<body>
    ...
    <div class="container form-container">
        <div class="card">
            <div class="card-header">
                <h3 class="mb-0"><i class="fas fa-edit me-2"></i>Edit Data Horizontal Displacement Meter</h3>
            </div>
            <div class="card-body">
                <!-- Alert Container -->
                ...
                <!-- Form Edit Data -->
                <form id="editForm" action="<?= base_url('horizontal-displacement/update/' . ($pengukuran['id_pengukuran'] ?? '')) ?>" method="post">
                    <?= csrf_field() ?>
                        ...
                        <div class="horizontal-readings">
                            <div class="reading-item">
                                ...
                                <input type="text" class="form-control numeric-input" id="elv625_hv1" name="elv625_hv1"
                                       pattern="[0-9]*\.?[0-9]*" title="Hanya angka dan titik diperbolehkan"
                                       placeholder="0.000" 
                                       value="<?= esc($pembacaanElv625['hv_1'] ?? '0') ?>">
                            </div>
                            ...
                            <div class="reading-item">
                                ...
                                <input type="text" class="form-control numeric-input" id="elv625_hv2" name="elv625_hv2"
                                       pattern="[0-9]*\.?[0-9]*" title="Hanya angka dan titik diperbolehkan"
                                       placeholder="0.000" 
                                       value="<?= esc($pembacaanElv625['hv_2'] ?? '0') ?>">
                            </div>
                            ...
                            <div class="reading-item">
                                ...
                                <input type="text" class="form-control numeric-input" id="elv625_hv3" name="elv625_hv3"
                                       pattern="[0-9]*\.?[0-9]*" title="Hanya angka dan titik diperbolehkan"
                                       placeholder="0.000" 
                                       value="<?= esc($pembacaanElv625['hv_3'] ?? '0') ?>">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="horizontal-readings">
                            <div class="reading-item">
                                ...
                                <input type="text" class="form-control numeric-input" id="elv600_hv1" name="elv600_hv1"
                                       pattern="[0-9]*\.?[0-9]*" title="Hanya angka dan titik diperbolehkan"
                                       placeholder="0.000" 
                                       value="<?= esc($pembacaanElv600['hv_1'] ?? '0') ?>">
                            </div>
                            ...
                            <div class="reading-item">
                                ...
                                <input type="text" class="form-control numeric-input" id="elv600_hv2" name="elv600_hv2"
                                       pattern="[0-9]*\.?[0-9]*" title="Hanya angka dan titik diperbolehkan"
                                       placeholder="0.000" 
                                       value="<?= esc($pembacaanElv600['hv_2'] ?? '0') ?>">
                            </div>
                            ...
                            <div class="reading-item">
                                ...
                                <input type="text" class="form-control numeric-input" id="elv600_hv3" name="elv600_hv3"
                                       pattern="[0-9]*\.?[0-9]*" title="Hanya angka dan titik diperbolehkan"
                                       placeholder="0.000" 
                                       value="<?= esc($pembacaanElv600['hv_3'] ?? '0') ?>">
                            </div>
                            ...
                            <div class="reading-item">
                                ...
                                <input type="text" class="form-control numeric-input" id="elv600_hv4" name="elv600_hv4"
                                       pattern="[0-9]*\.?[0-9]*" title="Hanya angka dan titik diperbolehkan"
                                       placeholder="0.000" 
                                       value="<?= esc($pembacaanElv600['hv_4'] ?? '0') ?>">
                            </div>
                            ...
                            <div class="reading-item">
                                ...
                                <input type="text" class="form-control numeric-input" id="elv600_hv5" name="elv600_hv5"
                                       pattern="[0-9]*\.?[0-9]*" title="Hanya angka dan titik diperbolehkan"
                                       placeholder="0.000" 
                                       value="<?= esc($pembacaanElv600['hv_5'] ?? '0') ?>">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="text-center mt-4 loading-spinner" id="loadingSpinner">
                        ...
                        <p class="mt-2 text-muted">Mengupdate data HDM...</p>
                    </div>
                </form>
            </div>
        </div>
    ...
    if (data.success) {
        if (data.hasChanges) {
            showAlert('Data berhasil diupdate dan pergerakan dihitung ulang! Mengalihkan...', 'success');
        } else {
            showAlert('Data berhasil disimpan tanpa perubahan! Mengalihkan...', 'info');
        }
        setTimeout(() => {
