...
<head>
    ...
    <style>
        ...
        /* Modal Akses - MODERN & FORMAL (SAMA DENGAN HDM) */
        ...
        /* Untuk header L-7, L-8, L-9 di row 1 */
        ...
        /* Untuk Upstream, As Bend, Downstream di row 2 */
...
// FUNGSI UNTUK MENDAPATKAN STATUS WARNA - SESUAI LOGIKA L7-L9 YANG DIPERBAIKI
function getStatusL7L9($t_psmetrik, $type) {
    switch($type) {
        case 'L7':
        case 'L07':
            // L-7: Aman ≤644.06 - 644.95, Peringatan 644.96 - 644.95, Bahaya ≥647.96
            // CATATAN: Ada inkonsistensi di range peringatan (644.96 - 644.95)
            // Saya asumsikan maksudnya: Aman ≤644.95, Peringatan 644.96 - 647.95, Bahaya ≥647.96
            if ($t_psmetrik <= 644.95) return 'aman';          // ≤ 644.95 → aman
            if ($t_psmetrik <= 647.95) return 'peringatan';    // 644.96 - 647.95 → peringatan
            return 'bahaya';                                   // ≥ 647.96 → bahaya
            
        case 'L8':
        case 'L08':
            // L-8: Aman ≤649.84 - 650.73, Peringatan 650.74 - 653.73, Bahaya ≥653.74
            if ($t_psmetrik <= 650.73) return 'aman';          // ≤ 650.73 → aman
            if ($t_psmetrik <= 653.73) return 'peringatan';    // 650.74 - 653.73 → peringatan
            return 'bahaya';                                   // ≥ 653.74 → bahaya
            
        case 'L9':
        case 'L09':
            // L-9: Aman ≤594.41 - 596.10, Peringatan 596.11 - 594.40, Bahaya ≥594.41
            // CATATAN: Ada inkonsistensi di range peringatan (596.11 - 594.40)
            // Saya asumsikan maksudnya: Aman ≤596.10, Peringatan 596.11 - ???, Bahaya ≥???
            // Karena nilai bahaya (594.41) sama dengan batas bawah aman, ada kesalahan data
            // Saya gunakan logika: Aman ≤596.10, sisanya peringatan
            if ($t_psmetrik <= 596.10) return 'aman';          // ≤ 596.10 → aman
            return 'peringatan';                               // > 596.10 → peringatan (karena bahaya tidak logis)
...
<div class="container-fluid py-4">
    ...
    <div class="table-header">
        <h2 class="table-title">
            <i class="fas fa-tachometer-alt me-2"></i>Piezometer - Grafik History L7-L9
        </h2>
    ...
    <!-- Modal Peringatan Hak Akses Modern & Formal (SAMA DENGAN HDM) -->
                ...
                <tr>
                    ...
                    <th colspan="4" rowspan="4">
                        <div class="ambang-batas-container">
                            ...
                            <div class="ambang-value aman-value">≤ 644.06 - 644.95</div>
                            <div class="ambang-header">Peringatan (El.m)</div>
                            <div class="ambang-value peringatan-value">644.96 - 647.95</div>
                            <div class="ambang-header">Bahaya (El.m)</div>
                            <div class="ambang-value bahaya-value">≥ 647.96</div>
                        </div>
                    </th>
                    ...
                    <th colspan="4" rowspan="4">
                        <div class="ambang-batas-container">
                            <div class="ambang-header">Ambang Batas</div>
                            <div class="ambang-header">Aman (El.m)</div>
                            <div class="ambang-value aman-value">≤ 649.84 - 650.73</div>
                            <div class="ambang-header">Peringatan (El.m)</div>
                            <div class="ambang-value peringatan-value">650.74 - 653.73</div>
                            <div class="ambang-header">Bahaya (El.m)</div>
                            <div class="ambang-value bahaya-value">≥ 653.74</div>
                        </div>
                    </th>
                    ...
                    <th colspan="4" rowspan="4">
                        <div class="ambang-batas-container">
                            <div class="ambang-header">Ambang Batas</div>
                            <div class="ambang-header">Aman (El.m)</div>
                            <div class="ambang-value aman-value">≤ 594.41 - 596.10</div>
                            <div class="ambang-header">Peringatan (El.m)</div>
                            <div class="ambang-value peringatan-value">≥ 596.11</div>
                            <div class="ambang-header">Bahaya (El.m)</div>
                            <div class="ambang-value bahaya-value">Data tidak valid</div>
                        </div>
                    </th>
                </tr>
            ...
            <tbody id="dataTableBody">
                ...
                <?php else: ?>
                    ...
                    foreach($sortedData as $item): 
                        ...
                        // Tentukan status dengan logika L7-L9 yang telah diperbaiki
                    ...
                    <tr data-pid="<?= $p['id_pengukuran'] ?>" class="data-row">
                        ...
                        <!-- Kolom Ambang Batas untuk L-7 dengan background warna -->
                        <td class="number-cell aman-column">644.06</td>
                        <td class="number-cell peringatan-column">644.96</td>
                        <td class="number-cell bahaya-column">647.96</td>
                        <!-- Kolom Status T.Psmetrik untuk L-7 - DENGAN BACKGROUND WARNA -->
                        <td class="number-cell status-<?= $status_L07 ?>">
                        ...
                        <!-- Kolom Ambang Batas untuk L-8 dengan background warna -->
                        <td class="number-cell aman-column">649.84</td>
                        <td class="number-cell peringatan-column">650.74</td>
                        <td class="number-cell bahaya-column">653.74</td>
                        <!-- Kolom Status T.Psmetrik untuk L-8 - DENGAN BACKGROUND WARNA -->
                        <td class="number-cell status-<?= $status_L08 ?>">
                        ...
                        <!-- Kolom Ambang Batas untuk L-9 dengan background warna -->
                        <td class="number-cell aman-column">594.41</td>
                        <td class="number-cell peringatan-column">596.11</td>
                        <td class="number-cell bahaya-column">594.41</td>
                        <!-- Kolom Status T.Psmetrik untuk L-9 - DENGAN BACKGROUND WARNA -->
                        <td class="number-cell status-<?= $status_L09 ?>">
    ...
    document.getElementById('exportExcel').addEventListener('click', function() {
        ...
        setTimeout(() => {
            try {
                ...
                const wb = XLSX.utils.table_to_book(table, {sheet: "Data Grafik History L7-L9"});
                
                const timestamp = new Date().toISOString().slice(0, 10).replace(/-/g, '');
                const filename = `Piezometer_Grafik_History_L7-L9_${timestamp}.xlsx`;
