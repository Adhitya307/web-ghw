...
<head>
    ...
    <style>
        ...
        /* Untuk header L-1, L-2, L-3 di row 1 */
...
// FUNGSI UNTUK MENDAPATKAN STATUS WARNA - SESUAI LOGIKA YANG BENAR
function getStatus($t_psmetrik, $type) {
    switch($type) {
        case 'L1':
        case 'L01':
            // L-1: Aman ≤647.84 - 648.93, Peringatan 648.94 - 650.63, Bahaya ≥650.64
            if ($t_psmetrik <= 648.93) return 'aman';          // ≤ 648.93 → aman
            if ($t_psmetrik <= 650.63) return 'peringatan';    // 648.94 - 650.63 → peringatan
            return 'bahaya';                                   // ≥ 650.64 → bahaya
            
        case 'L2':
        case 'L02':
            // L-2: Aman ≤647.86 - 648.95, Peringatan 648.96 - 650.65, Bahaya ≥650.66
            if ($t_psmetrik <= 648.95) return 'aman';          // ≤ 648.95 → aman
            if ($t_psmetrik <= 650.65) return 'peringatan';    // 648.96 - 650.65 → peringatan
            return 'bahaya';                                   // ≥ 650.66 → bahaya
            
        case 'L3':
        case 'L03':
            // L-3: Aman ≤613.75 - 614.84, Peringatan 614.85 - 616.54, Bahaya ≥616.55
            if ($t_psmetrik <= 614.84) return 'aman';          // ≤ 614.84 → aman
            if ($t_psmetrik <= 616.54) return 'peringatan';    // 614.85 - 616.54 → peringatan
            return 'bahaya';                                   // ≥ 616.55 → bahaya
...
<div class="container-fluid py-4">
    ...
    <div class="table-header">
        <h2 class="table-title">
            <i class="fas fa-water me-2"></i>Piezometer - Grafik History L1-L3
        </h2>
    ...
    <div class="table-responsive" id="tableContainer">
        <table class="data-table table table-bordered table-hover" id="exportTable">
            <thead>
                ...
                <!-- Row 2: Header bagian atas (Upstream, As Bend, Downstream) -->
                <tr>
                ...
                <tr>
                    ...
                    <th colspan="4" rowspan="4">
                        <div class="ambang-batas-container">
                            ...
                            <div class="ambang-value aman-value">≤ 647.84 - 648.93</div>
                            <div class="ambang-header">Peringatan (El.m)</div>
                            <div class="ambang-value peringatan-value">648.94 - 650.63</div>
                            <div class="ambang-header">Bahaya (El.m)</div>
                            <div class="ambang-value bahaya-value">≥ 650.64</div>
                        </div>
                    </th>
                    ...
                    <th colspan="4" rowspan="4">
                        <div class="ambang-batas-container">
                            <div class="ambang-header">Ambang Batas</div>
                            <div class="ambang-header">Aman (El.m)</div>
                            <div class="ambang-value aman-value">≤ 647.86 - 648.95</div>
                            <div class="ambang-header">Peringatan (El.m)</div>
                            <div class="ambang-value peringatan-value">648.96 - 650.65</div>
                            <div class="ambang-header">Bahaya (El.m)</div>
                            <div class="ambang-value bahaya-value">≥ 650.66</div>
                        </div>
                    </th>
                    ...
                    <th colspan="4" rowspan="4">
                        <div class="ambang-batas-container">
                            <div class="ambang-header">Ambang Batas</div>
                            <div class="ambang-header">Aman (El.m)</div>
                            <div class="ambang-value aman-value">≤ 613.75 - 614.84</div>
                            <div class="ambang-header">Peringatan (El.m)</div>
                            <div class="ambang-value peringatan-value">614.85 - 616.54</div>
                            <div class="ambang-header">Bahaya (El.m)</div>
                            <div class="ambang-value bahaya-value">≥ 616.55</div>
                        </div>
                    </th>
                </tr>
                ...
                <!-- Row 7: Final Headers - PERUBAHAN PENTING: HEADER WARNA -->
                <tr>
            ...
            <tbody id="dataTableBody">
                ...
                <?php else: ?>
                    ...
                    foreach($sortedData as $item): 
                        ...
                        $bacaan_L01 = $item['pembacaan']['L_01']['feet'] ?? 0;
                        $bacaan_L02 = $item['pembacaan']['L_02']['feet'] ?? 0;
                        $bacaan_L03 = $item['pembacaan']['L_03']['feet'] ?? 0;
                        
                        $t_psmetrik_L01 = $item['perhitungan_l01']['t_psmetrik'] ?? 0;
                        $t_psmetrik_L02 = $item['perhitungan_l02']['t_psmetrik'] ?? 0;
                        $t_psmetrik_L03 = $item['perhitungan_l03']['t_psmetrik'] ?? 0;
                        ...
                        // Tentukan status dengan logika yang telah diperbaiki
                    ...
                    <tr data-pid="<?= $p['id_pengukuran'] ?>" class="data-row">
                        ...
                        <!-- Kolom Ambang Batas untuk L-1 dengan background warna -->
                        <td class="number-cell aman-column">647.84</td>
                        <td class="number-cell peringatan-column">648.94</td>
                        <td class="number-cell bahaya-column">650.64</td>
                        <!-- Kolom Status T.Psmetrik untuk L-1 - DENGAN BACKGROUND WARNA -->
                        <td class="number-cell status-<?= $status_L01 ?>">
                        ...
                        <!-- Kolom Ambang Batas untuk L-2 dengan background warna -->
                        <td class="number-cell aman-column">647.86</td>
                        <td class="number-cell peringatan-column">648.96</td>
                        <td class="number-cell bahaya-column">650.66</td>
                        <!-- Kolom Status T.Psmetrik untuk L-2 - DENGAN BACKGROUND WARNA -->
                        <td class="number-cell status-<?= $status_L02 ?>">
                        ...
                        <!-- Kolom Ambang Batas untuk L-3 dengan background warna -->
                        <td class="number-cell aman-column">613.75</td>
                        <td class="number-cell peringatan-column">614.85</td>
                        <td class="number-cell bahaya-column">616.55</td>
                        <!-- Kolom Status T.Psmetrik untuk L-3 - DENGAN BACKGROUND WARNA -->
                        <td class="number-cell status-<?= $status_L03 ?>">
    ...
    document.getElementById('exportExcel').addEventListener('click', function() {
        ...
        setTimeout(() => {
            try {
                ...
                const wb = XLSX.utils.table_to_book(table, {sheet: "Data Grafik History L1-L3"});
                
                const timestamp = new Date().toISOString().slice(0, 10).replace(/-/g, '');
                const filename = `Piezometer_Grafik_History_L1-L3_${timestamp}.xlsx`;
