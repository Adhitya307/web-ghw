...
<head>
    ...
    <style>
        ...
        /* Untuk header L-4, L-5, L-6 di row 1 */
...
// FUNGSI UNTUK MENDAPATKAN STATUS WARNA - SESUAI LOGIKA L4-L6 YANG DIPERBAIKI
function getStatusL4L6($t_psmetrik, $type) {
    switch($type) {
        case 'L4':
        case 'L04':
            // L-4: Aman ≤560.86 - 565.35, Peringatan 565.36 - 569.65, Bahaya ≥569.66
            if ($t_psmetrik <= 565.35) return 'aman';          // ≤ 565.35 → aman
            if ($t_psmetrik <= 569.65) return 'peringatan';    // 565.36 - 569.65 → peringatan
            return 'bahaya';                                   // ≥ 569.66 → bahaya
            
        case 'L5':
        case 'L05':
            // L-5: Aman ≤691.46 - 692.35, Peringatan 692.36 - 695.35, Bahaya ≥695.36
            if ($t_psmetrik <= 692.35) return 'aman';          // ≤ 692.35 → aman
            if ($t_psmetrik <= 695.35) return 'peringatan';    // 692.36 - 695.35 → peringatan
            return 'bahaya';                                   // ≥ 695.36 → bahaya
            
        case 'L6':
        case 'L06':
            // L-6: Aman ≤680.79 - 681.68, Peringatan 681.69 - 684.68, Bahaya ≥684.69
            if ($t_psmetrik <= 681.68) return 'aman';          // ≤ 681.68 → aman
            if ($t_psmetrik <= 684.68) return 'peringatan';    // 681.69 - 684.68 → peringatan
            return 'bahaya';                                   // ≥ 684.69 → bahaya
...
<div class="container-fluid py-4">
    ...
    <div class="table-header">
        <h2 class="table-title">
            <i class="fas fa-tachometer-alt me-2"></i>Piezometer - Grafik History L4-L6
        </h2>
                ...
                <tr>
                    ...
                    <th colspan="4" rowspan="4">
                        <div class="ambang-batas-container">
                            ...
                            <div class="ambang-value aman-value">≤ 560.86 - 565.35</div>
                            <div class="ambang-header">Peringatan (El.m)</div>
                            <div class="ambang-value peringatan-value">565.36 - 569.65</div>
                            <div class="ambang-header">Bahaya (El.m)</div>
                            <div class="ambang-value bahaya-value">≥ 569.66</div>
                        </div>
                    </th>
                    ...
                    <th colspan="4" rowspan="4">
                        <div class="ambang-batas-container">
                            <div class="ambang-header">Ambang Batas</div>
                            <div class="ambang-header">Aman (El.m)</div>
                            <div class="ambang-value aman-value">≤ 691.46 - 692.35</div>
                            <div class="ambang-header">Peringatan (El.m)</div>
                            <div class="ambang-value peringatan-value">692.36 - 695.35</div>
                            <div class="ambang-header">Bahaya (El.m)</div>
                            <div class="ambang-value bahaya-value">≥ 695.36</div>
                        </div>
                    </th>
                    ...
                    <th colspan="4" rowspan="4">
                        <div class="ambang-batas-container">
                            <div class="ambang-header">Ambang Batas</div>
                            <div class="ambang-header">Aman (El.m)</div>
                            <div class="ambang-value aman-value">≤ 680.79 - 681.68</div>
                            <div class="ambang-header">Peringatan (El.m)</div>
                            <div class="ambang-value peringatan-value">681.69 - 684.68</div>
                            <div class="ambang-header">Bahaya (El.m)</div>
                            <div class="ambang-value bahaya-value">≥ 684.69</div>
                        </div>
                    </th>
                </tr>
            ...
            <tbody id="dataTableBody">
                ...
                <?php else: ?>
                    ...
                    foreach($sortedData as $item): 
                        ...
                        // Tentukan status dengan logika L4-L6 yang telah diperbaiki
                    ...
                    <tr data-pid="<?= $p['id_pengukuran'] ?>" class="data-row">
                        ...
                        <!-- Kolom Ambang Batas untuk L-4 dengan background warna -->
                        <!-- TAMPILKAN RANGE, BUKAN NILAI TUNGGAL -->
                        <td class="number-cell aman-column">560.86</td>
                        <td class="number-cell peringatan-column">565.36</td>
                        <td class="number-cell bahaya-column">569.66</td>
                        <!-- Kolom Status T.Psmetrik untuk L-4 - DENGAN BACKGROUND WARNA -->
                        <td class="number-cell status-<?= $status_L04 ?>">
                        ...
                        <!-- Kolom Ambang Batas untuk L-5 dengan background warna -->
                        <td class="number-cell aman-column">691.46</td>
                        <td class="number-cell peringatan-column">692.36</td>
                        <td class="number-cell bahaya-column">695.36</td>
                        <!-- Kolom Status T.Psmetrik untuk L-5 - DENGAN BACKGROUND WARNA -->
                        <td class="number-cell status-<?= $status_L05 ?>">
                        ...
                        <!-- Kolom Ambang Batas untuk L-6 dengan background warna -->
                        <td class="number-cell aman-column">680.79</td>
                        <td class="number-cell peringatan-column">681.69</td>
                        <td class="number-cell bahaya-column">684.69</td>
                        <!-- Kolom Status T.Psmetrik untuk L-6 - DENGAN BACKGROUND WARNA -->
                        <td class="number-cell status-<?= $status_L06 ?>">
    ...
    document.getElementById('exportExcel').addEventListener('click', function() {
        ...
        setTimeout(() => {
            try {
                ...
                const wb = XLSX.utils.table_to_book(table, {sheet: "Data Grafik History L4-L6"});
                
                const timestamp = new Date().toISOString().slice(0, 10).replace(/-/g, '');
                const filename = `Piezometer_Grafik_History_L4-L6_${timestamp}.xlsx`;
