...
<head>
    ...
    <title><?= $title ?? 'Profil A Monitoring - PT Indonesia Power' ?></title>
...
<div class="container-fluid py-4">
    ...
    <div class="table-header">
        <h2 class="table-title">
            <i class="fas fa-chart-line me-2 text-info"></i>Profil A - Data Monitoring
        </h2>
        ...
        <div class="d-flex flex-wrap gap-2 mb-3">
            ...
            <button type="button" class="btn btn-export" onclick="exportProfilAExcel()">
    ...
    <div class="table-container-wrapper">
        <div class="table-responsive" id="tableContainer">
            <div class="loading-overlay" id="tableLoading" style="display: none;">
                ...
                <div class="text-muted fw-medium">Memuat data Profil A...</div>
            </div>
            
            <div id="tablePlaceholder" class="table-placeholder">
                <i class="fas fa-chart-line fa-3x text-muted mb-3"></i>
                <h4 class="text-muted fw-medium mb-2">Data Profil A Belum Ditampilkan</h4>
            ...
            <div id="dataTableWrapper" style="display: none;">
                <table class="table table-bordered table-striped table-hover mb-0" id="profilATable">
            ...
            <div id="noDataMessage" class="table-placeholder" style="display: none;">
                ...
                <h4 class="text-muted fw-medium mb-2">Tidak Ada Data Profil A</h4>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // Apply filter
    applyFilter.addEventListener('click', loadProfilAData);
...
async function loadProfilAData() {
    ...
    try {
        ...
        const response = await fetch(`<?= site_url('inclino/profilea/getDataByYear') ?>?${params}`);
        const result = await response.json();
        
        if (result.status === 'success') {
            currentProfilAData = result.data;
            currentData = currentProfilAData.data || [];
            
            // Render tabel
            if (currentData.length > 0) {
                renderProfilATable(currentData, currentProfilAData.dates);
                showTable(true);
                showMetadata(currentProfilAData.metadata);
...
// ============ FUNGSI RENDER TABEL ============
function renderProfilATable(data, dates) {
...
function updatePagination(count) {
    ...
    document.getElementById('totalCount').textContent = currentProfilAData ? currentProfilAData.metadata.total_records : 0;
}
...
function exportProfilAExcel() {
    ...
    let url = '<?= site_url("inclino/profilea/exportToExcel") ?>?';
