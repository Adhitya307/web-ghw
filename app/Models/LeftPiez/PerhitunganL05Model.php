...
class PerhitunganL05Model extends Model
{
    protected $DBGroup = 'db_left_piez';
    protected $table = 'perhitungan_L_05';
    ...
    protected $allowedFields = [
        ...
        'koordinat_x',
        'koordinat_y',
        't_psmetrik_L05' // kolom baru untuk hasil perhitungan
    ];

    protected $useTimestamps = false;

    // Default value khusus L05
    protected $defaults = [
        'Elv_Piez'  => 700.76,
        'kedalaman' => 62,
        't_psmetrik_L05' => 0
    ...
    /**
     * Hitung nilai l_05 seperti rumus Excel
     */
    public function hitungL05($id_pengukuran)
    {
        ...
        $l_05 = $metrik['l_05'] ?? null;

        // IFERROR logic: gunakan elv - l_05 jika ada, else elv - kedalaman
        $result = is_numeric($l_05) ? $elv - $l_05 : $elv - $kedalaman;
    ...
    public function insert($data = null, bool $returnID = true)
    {
        ...
        if (isset($data['id_pengukuran'])) {
            $nilai = $this->hitungL05($data['id_pengukuran']);
          
            $data['t_psmetrik_L05'] = $nilai; // simpan di kolom baru
        }
