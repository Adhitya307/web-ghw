...
class ScatterBt7Model extends Model
{
    protected $DBGroup          = 'btm';
    protected $table            = 'p_scatter_bt_7';
    ...
    /**
     * Hitung dan simpan data scatter untuk BT-7
     */
    ...
    {
        return $this->select('p_scatter_bt_7.*')
                   ->join('t_pengukuran_btm t', 't.id_pengukuran = p_scatter_bt_7.id_pengukuran')
                   ->where('p_scatter_bt_7.id_pengukuran <', $idPengukuran)
                   ->orderBy('t.tahun ASC, t.periode ASC, t.tanggal ASC, p_scatter_bt_7.id_pengukuran ASC')
                   ->first();
    }
    ...
    public function recalculateAllCumulative()
    {
        ...
        $allScatterData = $this->select('p_scatter_bt_7.*, t.tahun, t.periode, t.tanggal')
                              ->join('t_pengukuran_btm t', 't.id_pengukuran = p_scatter_bt_7.id_pengukuran')
                              ->orderBy('t.tahun ASC, t.periode ASC, t.tanggal ASC, p_scatter_bt_7.id_pengukuran ASC')
                              ->findAll();
    ...
    public function recalculateCumulativeFrom($startIdPengukuran)
    {
        ...
        $allScatterData = $this->select('p_scatter_bt_7.*, t.tahun, t.periode, t.tanggal')
                              ->join('t_pengukuran_btm t', 't.id_pengukuran = p_scatter_bt_7.id_pengukuran')
                              ->where('p_scatter_bt_7.id_pengukuran >=', $startIdPengukuran)
                              ->orderBy('t.tahun ASC, t.periode ASC, t.tanggal ASC, p_scatter_bt_7.id_pengukuran ASC')
                              ->findAll();
        ...
        $previousData = $this->select('Y_cum, X_cum')
                           ->join('t_pengukuran_btm t', 't.id_pengukuran = p_scatter_bt_7.id_pengukuran')
                           ->where('p_scatter_bt_7.id_pengukuran <', $startIdPengukuran)
                           ->orderBy('t.tahun DESC, t.periode DESC, t.tanggal DESC, p_scatter_bt_7.id_pengukuran DESC')
                           ->first();
    ...
    {
        return $this->select('p_scatter_bt_7.*, t.tahun, t.periode, t.tanggal')
                   ->join('t_pengukuran_btm t', 't.id_pengukuran = p_scatter_bt_7.id_pengukuran')
